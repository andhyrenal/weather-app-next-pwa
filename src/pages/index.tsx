...
export default function Home() {
  ...
  if (isLoading) {
    return (
      <div
        className="fixed top-2/4 left-2/4 inline-block h-8 w-8 animate-spin rounded-full border-4 border-solid border-current border-r-zinc-500 align-[-0.125em] text-primary motion-reduce:animate-[spin_1.5s_linear_infinite]"
        role="status"
      >
